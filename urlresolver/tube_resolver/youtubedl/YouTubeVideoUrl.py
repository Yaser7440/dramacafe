...
try:from . import sslContext
except:sslContext=None
...
#maxResolution ='22'
#ConfigSelection(default = '22', choices = [
	#('38', '3072p'), ('37', '1080p'), ('22', '720p'), ('35', '480p'), 
	#('18', '360p'), ('5', '240p'), ('17', '144p')])
def createPriorityFormats(maxResolution):
...
class YouTubeVideoUrl():
	...
	def extract(self, video_id,maxResolution):
		...
		if 'conn' in video_info and video_info['conn'][0][:4] == 'rtmp':
			...
			if PRIORITY_VIDEO_FORMAT[0] != maxResolution:
				createPriorityFormats(maxResolution)
